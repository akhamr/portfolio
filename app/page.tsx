...
export default function Main() {
  return (
    <section className="relative flex h-full cursor-pencil items-center justify-center pb-6 md:w-screen md:pr-2.5 md:pb-0 dark:cursor-pencil-dark">
      <div className="flex flex-col items-center justify-center md:flex-row md:justify-between">
        <div className="relative hidden w-87.5 place-items-center md:w-100 dark:grid">
          <Image alt="doodle" src={MeDark} priority />
          <Doodle1 className="absolute bottom-0 stroke-[#ffd55a]/70" />
        </div>
        <div className="relative grid w-87.5 place-items-center md:w-100 dark:hidden">
        ...
        <div className="flex flex-col items-center justify-center space-y-4 md:ml-4 md:items-start">
          <h1 className="mt-1 font-doodle text-3xl md:text-4xl">
            ...
            <span className="relative mx-1.5">
              akha.
              <Doodle2 className="absolute -right-4 -bottom-2 hidden w-24 stroke-[#ffd55a]/70 md:w-28 dark:block" />
              <Doodle2 className="absolute -right-4 -bottom-2 block w-24 stroke-[#a3a3a3]/70 md:w-28 dark:hidden" />
            </span>
            &#129300;
          </h1>
          <p className="text-base max-w-125 text-center md:text-left md:text-lg">
